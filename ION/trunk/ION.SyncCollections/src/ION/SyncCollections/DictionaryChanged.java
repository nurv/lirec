...
import ion.SyncCollections.Events.Dictionary.IDictionaryChanged;

class DictionaryChanged<TDictionary> extends Event implements IDictionaryChanged {

    final TDictionary dictionary;
