...
final class Added<TKey, TValue, TDictionary> extends DictionaryChangedInternal<TKey, TValue, TDictionary> implements IAddedDictionary<TKey, TValue, TDictionary> {

    public Added(TKey key, TValue value, TDictionary dictionary) {
