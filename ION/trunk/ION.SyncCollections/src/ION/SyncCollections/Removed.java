...
final class Removed<TKey, TValue, TDictionary> extends DictionaryChangedInternal<TKey, TValue, TDictionary> implements IRemovedDictionary<TKey, TValue, TDictionary> {

    public Removed(TKey key, TValue value, TDictionary dictionary) {
        super(key, value, dictionary);
    }
}
