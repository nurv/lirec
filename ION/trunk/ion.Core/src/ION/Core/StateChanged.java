...
import ion.Core.Action.State;
import ion.Core.Events.IStateChanged;
import ion.Meta.Event;

class StateChanged<TAction extends Action> extends Event implements IStateChanged<TAction> {

    private final TAction action;
    private final Action.State oldState;

    public StateChanged(TAction action, Action.State oldState) {
        this.action = action;
