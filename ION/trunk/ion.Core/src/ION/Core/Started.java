...
final class Started<TAction extends Action> extends StateChanged<TAction> implements IStarted<TAction> {

    public Started(TAction action, Action.State oldState) {
