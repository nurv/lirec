...
public final class ValueChanged<TOldValue, TNewValue, TProperty extends Property> extends Event implements IValueChanged<TOldValue, TNewValue, TProperty> {

    private final TOldValue oldValue;
    private final TNewValue newValue;
