...
final class Resumed<TAction extends Action> extends StateChanged<TAction> implements IResumed<TAction> {

    public Resumed(TAction action, Action.State oldState) {
