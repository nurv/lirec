 ...
 * 
 * @author GAIPS
 * @param <TAction> the particular type of the Action
 */
public interface IStateChanged<TAction extends Action> extends IEvent {

    /**
     * Gets the Action which State has changed.
     * 
     * @return the Action which state has changed
     */
    TAction getAction();
     ...
     * 
     * @return the previous state of the Action
     */
