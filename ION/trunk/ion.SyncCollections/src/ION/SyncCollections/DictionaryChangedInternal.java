...
class DictionaryChangedInternal<TKey, TValue, TDictionary> extends DictionaryChanged<TDictionary> implements IDictionaryChangedInternal {

    final TKey key;
    final TValue value;
    
    public DictionaryChangedInternal(TKey key, TValue value, TDictionary dictionary){
        super(dictionary);
        this.key = key;
        this.value = value;
    }
