...
public abstract class Request {
    ...
    public SimulationTime getScheduleTime() {
        return this.scheduleTime.duplicate();
    }

    void setScheduleTime(SimulationTime scheduleTime) {
        if (this.scheduleTime == null) {
            this.scheduleTime = scheduleTime.duplicate();
        }
    }
}
