...
public class TypeSetArgumentException extends IllegalArgumentException {

    private final TypeSet typeSet;

    public TypeSetArgumentException(String message, String paramName, TypeSet typeSet) {
        super("Argument: "+paramName+". "+message);
