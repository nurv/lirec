...
import ion.Meta.Events.ISimulationUpdated;

final class SimulationUpdated extends Event implements ISimulationUpdated {

    private final Simulation simulation;

    public SimulationUpdated(Simulation simulation){
