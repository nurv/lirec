...
public class InTheWildWoz extends AgentMindConnector {

	/** reference to the gui */
	InTheWildWozFrame wozGUI;
	
	public InTheWildWoz(IArchitecture architecture) {
		...
		{
			public void run() {
				wozGUI = new InTheWildWozFrame(InTheWildWoz.this);
	...
	protected void processActionFailure(MindAction a) 
	{
		...
		if (a.getName().equals("talk") && a.getSubject().equals("Greta"))
			newLogLine = "FAIL!!!!!" + a.getParameters().get(0);
		else if (a.getName().equals("emotion") && a.getSubject().equals("Greta"))
			newLogLine = "FAIL!!!!! emotion: " + a.getParameters().get(0);
		else if (a.getName().equals("gesture") && a.getSubject().equals("Greta"))
			newLogLine = "FAIL!!!!! gesture: " + a.getParameters().get(0);
	...
	protected void processActionSuccess(MindAction a) 
	{
		...
		if (a.getName().equals("talk") && a.getSubject().equals("Greta"))
			...
			newLogLine = "***** gesture: " + a.getParameters().get(0);
		else if (a.getName().equals("sendSMS") && a.getSubject().equals("Greta"))
