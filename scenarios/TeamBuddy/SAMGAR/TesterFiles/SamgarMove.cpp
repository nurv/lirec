...
int main(int argc, char** argv)
{
  ...
  Network yarp;
  SamgarModule IntReciver("Move","MoveRobot","Motion",interupt); 
  ...
  robot.runAsync(false);
	  ...
	  while( 1 ) 
	  {
		...
		// ArRobot's background thread will be blocked and unable to communicate with the robot, call tasks, etc.
