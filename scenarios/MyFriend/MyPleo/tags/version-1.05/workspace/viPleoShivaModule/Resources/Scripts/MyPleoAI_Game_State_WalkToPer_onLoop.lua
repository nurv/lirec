...
--------------------------------------------------------------------------------
function MyPleoAI_Game.WalkToPer_onLoop ( )
--------------------------------------------------------------------------------
    ...
    log.message ( "WALK TO PERCURSO" )
    
    
    if ( object.hasController ( o, object.kControllerTypeNavigation ) and  navigation.getNode   ( o ) )
    then
            navigation.setNearestTargetNode ( o, application.getCurrentUserSceneTaggedObject ( this.hPer ( )) )
    end
