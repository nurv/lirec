...
public class EmotionalPlanner implements Serializable {
	 ...
	 * 			 returns null
	 */
	public Plan ThinkAbout(AgentModel am, DeliberativeComponent2 dp, Intention intention) {
		Plan p;
		Plan newPlan;
		...
		af.SetAppraisalVariable(DeliberativeComponent2.NAME, (short)7, OCCAppraisalVariables.SUCCESSPROBABILITY.name(), goalProb);
		af.SetAppraisalVariable(DeliberativeComponent2.NAME, (short)7, OCCAppraisalVariables.FAILUREPROBABILITY.name(), 1-goalProb);
		...
		while(li.hasNext()) {
			...
			auxFrame.SetAppraisalVariable(DeliberativeComponent2.NAME, (short)6, OCCAppraisalVariables.FAILUREPROBABILITY.name(), prob);
			auxFrame.SetAppraisalVariable(DeliberativeComponent2.NAME, (short)6, OCCAppraisalVariables.GOALCONDUCIVENESS.name(), tGoal.GetImportanceOfFailure(am));
			auxFrame.SetAppraisalVariable(DeliberativeComponent2.NAME, (short)6, OCCAppraisalVariables.GOALSTATUS.name(), OCCAffectDerivationComponent.GOALUNCONFIRMED);
