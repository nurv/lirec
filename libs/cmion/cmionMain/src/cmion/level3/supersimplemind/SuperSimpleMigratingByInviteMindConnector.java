...
public class SuperSimpleMigratingByInviteMindConnector extends AgentMindConnector implements Migrating, MigrationAware {

	
	/** the mind itself */
	private SuperSimpleMigratingByInviteMind mind;
	
	/** creates a new connector for a SuperSimpleMind */ 
	public SuperSimpleMigratingByInviteMindConnector(IArchitecture architecture)
	{	
		super(architecture);
		// create the mind, initially sleeping
		mind = new SuperSimpleMigratingByInviteMind(this);
	}
