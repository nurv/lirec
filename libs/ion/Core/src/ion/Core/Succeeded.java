...
final class Succeeded<TAction extends Action> extends StateChanged<TAction> implements ISucceeded<TAction> {

    public Succeeded(TAction action, Action.State oldState) {
        super(action, oldState);
    }
}
