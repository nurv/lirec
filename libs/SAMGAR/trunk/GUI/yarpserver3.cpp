...
int main(int argc, char *argv[]) 
{
   ...
   QApplication app(argc, argv);
    ...
    QFile::remove("ports.db");
	QFile::remove("subs.db");
   myconnwindow = new MyConnectionView();

   myconnwindow->mylogwindow->WriteToLog("Samgar V3 Started",true);
...
\\ \\ / // \\  |  _ \\|  _ \\ \n\
 \\ V // _ \\ | |_) | |_) |\n\
  ...
  |_/_/   \\_\\_| \\_\\_|    \n\n");
   ...
   ControlPort.setReporter(myPortStatus);
   ControlPort.useCallback();
   ControlPort.open("/CONTROL");
   ControlPort.setStrict(true); /// this should queue up msgs, hopefully stop the occasional crash and update the gui more faithfully
